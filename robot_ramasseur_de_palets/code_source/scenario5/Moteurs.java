...
public class Moteurs
{
	...
	{
		//Description: le robot avance droit jusqu'à trouver une ligne rouge ou jaune
		//Entrée: rien
		//Sortie: rien
		
		int couleur = blanc; // Variable qui va contenir l'id de la couleur détectée (initialisée à blanc)
		couleur = CapteurPhotosensible.obtenirIDCouleur();
		while (couleur != 0 && couleur != 3) // Tant que la couleur détectée est différente du rouge et du jaune, le robot avance droit 
		{
